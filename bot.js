...
client.on("message", (message) => {
    if(message.member.hasPermission("ADMINISTRATOR")){  //Who need prefix argument omegalul
        ...
        else if(command === 'help')
        {
            const helpEmbed = new Discord.MessageEmbed()
                ...
                .setAuthor('shaftAndi#1825', 'https://cdn.discordapp.com/avatars/571412838388727809/52c80f084a56582f9485cd52e43d9e1e.png?size=128')
        ...
        message.channel.send("Only users with the Administrator permission may use this bot!");
